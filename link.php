...
<div id="publishingContainer">
	...
	<ul class="page-link" style="width:100%;margin-bottom:-50px">
		...
		<!-- 
		<li>
			<a href="./works.php" target="_blank" class="">works 관리</a>
			<ul>
				<li><a href="./works_regist.php" target="_blank" class="">works 등록</a></li>
				<li><a href="./works_modify.php" target="_blank" class="">works 수정</a></li>
			</ul>
		</li> -->
